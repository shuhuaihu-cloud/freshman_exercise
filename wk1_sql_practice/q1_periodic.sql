WITH user_orders AS (
    SELECT
        ...
        u.cust_gender,
        CASE
            WHEN EXTRACT(YEAR FROM o.order_create_dt) - EXTRACT(YEAR FROM u.cust_birth_date) < 25 THEN '<25'
            WHEN EXTRACT(YEAR FROM o.order_create_dt) - EXTRACT(YEAR FROM u.cust_birth_date) BETWEEN 25 AND 29 THEN '25-30'
            WHEN EXTRACT(YEAR FROM o.order_create_dt) - EXTRACT(YEAR FROM u.cust_birth_date) BETWEEN 30 AND 39 THEN '30-40'
            WHEN EXTRACT(YEAR FROM o.order_create_dt) - EXTRACT(YEAR FROM u.cust_birth_date) BETWEEN 40 AND 49 THEN '40-50'
            WHEN EXTRACT(YEAR FROM o.order_create_dt) - EXTRACT(YEAR FROM u.cust_birth_date) BETWEEN 50 AND 59 THEN '50-60'
            ELSE '>=60'
        END AS age_bucket,
        o.order_create_dt,
    ...
    WHERE o.order_create_dt >= DATE('2024-01-01') AND o.order_create_dt < DATE('2025-01-01')
)
, intervals AS (
    SELECT
        acct_id,
